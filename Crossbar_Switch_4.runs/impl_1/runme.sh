...
HD_PWD='D:/HDL/Crossbar_Switch_4/Crossbar_Switch_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stimulus_for_Crossbar4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stimulus_for_Crossbar4.tcl -notrace
